...
4. Read normal X11 requests into a typed `Request` struct.
5. Track atoms in a small server-side atom table.
6. Reply to extension discovery requests.
...
request #1: opcode 98 (QueryExtension) data 0 length 5 (20 bytes)
  QueryExtension "BIG-REQUESTS": not present
